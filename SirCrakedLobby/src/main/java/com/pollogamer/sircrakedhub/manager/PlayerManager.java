...
public class PlayerManager {
    ...
    public static ItemStackBuilder compass = new ItemStackBuilder(Material.COMPASS).setName("§ks§a§lSeleccion de servidores§f§kj");
    public static ItemStackBuilder cosmeticos = new ItemStackBuilder(Material.ENDER_CHEST).setName("§b§lCosmeticos");
    public static ItemStackBuilder skull = new ItemStackBuilder(Material.SKULL_ITEM).setStackData((short) 3).setName("§aMi Perfil");
    public static ItemStackBuilder Lobbies = new ItemStackBuilder().setMaterial(Material.NETHER_STAR).setName("§aLobbies");
    ...
    public static void setplayerkit(Player p) {
        p.getInventory().clear();
        p.getInventory().setItem(0, compass);
        p.getInventory().setItem(1, skull);
        p.getInventory().setItem(4, cosmeticos);
        if (ServerManager.lobbies.size() > 1) {
            p.getInventory().setItem(8, Lobbies);
        }
    }
