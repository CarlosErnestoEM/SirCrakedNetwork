package com.pollogamer.sircrakedhub.objects;
...
public class ListServer {
    ...
    public void init() {
        for (String s : Principal.plugin.getServers().getStringList("servers.listserver." + type + ".allowed-stages")) {
            allowedstages.add(s);
        }
        for (String s : Principal.plugin.getServers().getStringList("servers.listserver." + type + ".starting-stages")) {
