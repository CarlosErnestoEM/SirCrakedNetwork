...
public class NewServerPing {
    ...
    public class StatusResponse {
        ...
        private NewServerPing.Players players;
        private NewServerPing.Version version;
        ...
        public NewServerPing.Players getPlayers() {
            return this.players;
        }

        public NewServerPing.Version getVersion() {
            return this.version;
        }
