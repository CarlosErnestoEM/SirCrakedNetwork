...
public class PunishUIMainPageHelper extends GUIPage<SirCrakedCore> {

    private String punishedPlayer;

    public PunishUIMainPageHelper(SirCrakedCore plugin, Player player, String punishedPlayer) {
    ...
    public void buildPage() {
        ...
        addButton(new OpenSubPageButton(chatOffense, OffensePage.CHAT, punishedPlayer, true), 11);
        addButton(new OpenSubPageButton(gameplayOffense, OffensePage.GAMEPLAY, punishedPlayer, true), 13);
        addButton(new OpenSubPageButton(punishmentHistory, OffensePage.HISTORY, punishedPlayer, true), 15);
